...
2. Жмёшь **плюсик** и выбираешь **Custom setup** - версия **1.21.11**, загрузчик **Fabric** <Image src="/assets/guides/mods/modrinth_create.webp" alt="Создание сборки в Modrinth App" width="100%" preview />
...
::: tip Ещё проще
У нас есть [готовые сборки](/info/mods.md#modpack) в формате `.mrpack` - такую Modrinth App ставит через тот же плюсик, только пунктом **Install modpack**.
:::
