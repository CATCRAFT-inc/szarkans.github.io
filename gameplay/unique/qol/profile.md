...
::: warning Страница переписывается
Профиль игрока переделали вместе с сервером — часть написанного ниже уже
неверна. Скоро обновим.
:::
...
- Ваши роли (модератор, репортёр и т.п.)
- Котик+ и когда он закончится
- Выполненные достижения за наигранные часы
- Ваш пол
- Медали за [Котячьи заслуги](/gameplay/unique/qol/rewards.md)
- Особые медали
  - Игра на сезонах
  - Легенда Кошкокрафта
...
<!-- Скрыто: было «Ваши роли (Офицер КСБ, модератор, репортёр и т.п.)» -->
