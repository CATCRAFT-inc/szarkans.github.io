...
//
// ОДИНОЧНАЯ ССЫЛКА В МЕНЮ: запись без `items`, только `text` и `link`
// (`{ text: '<span class="sidebar-back">← Все механики</span>', link: … }`).
// Класс `sidebar-back` красит её лавандовым — серый текст читался бы
// как заголовок, а на телефоне hover'а нет вовсе. Такая строка
// появляется в боковом меню, но НЕ попадает на страницу-хаб — там она была бы
// ссылкой на саму себя. Так сделана дорога обратно из статьи в хаб раздела.

export const bestiarySidebar = [
  // Дорога обратно на страницу-вход. Без неё из статьи в хаб не выбраться
  // иначе как через навбар. Строка БЕЗ `items` — это просто ссылка в меню,
  // в сам хаб она не попадает (там она была бы ссылкой на саму себя).
  { text: '<span class="sidebar-back">← Весь бестиарий</span>', link: '/bestiary/main.md' },
  {
    text: 'Разное',
    items: [
...
export const mechanicsSidebar = [
  { text: '<span class="sidebar-back">← Все механики</span>', link: '/gameplay/main.md' },
  {
    text: 'Чем заняться',
    featured: true,
    items: [
