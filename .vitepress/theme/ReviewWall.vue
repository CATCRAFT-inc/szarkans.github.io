...
function getAvatar(r) {
  return r.avatar || `https://cravatar.eu/avatar/${r.nick}/50.png`
}
const allReviews = [
  ...
  { avatar: '/assets/l_vitek_l.png', name: 'l_vitek_l', text: 'СНРВЕР ДАСТАТАЧНА ХАРОШЫЙ ДЛЯ ИГРЫ С ДРУЗЬЯМИ, НО ЭТО НЕ ТОЧНО. Ладно потом что-то нормальное придумаю' },
