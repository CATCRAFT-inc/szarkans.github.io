...
const faqItems = [
  {
    title: 'Что вы такое?',
    content: `Мы Ванилла+ РПГ сервер - добавляем новый контент в ванильный Майнкрафт и приправляем это щепоткой РП!`
  },
  {
    title: 'Какая версия?',
    content: 'Версия сезона <b>REBORN</b> - 1.21.11 Java Edition! С Bedrock Edition зайти нельзя.'
  },
  {
    title: 'Нужна лицензия?',
    content: 'Да! Наш сервер полностью лицензионный.'
  },
  {
    title: 'Почему "Кошкокрафт"? Вы "няняня"?',
    content: `У этого названия есть <a href="https://wiki.catcraft.ru/history/1season/1season" target="_blank" rel="noopener">целая история</a>!`
  }
]
